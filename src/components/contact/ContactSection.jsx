...
const fieldClass = (hasError) =>
  `w-full px-4 py-4 text-black placeholder:text-black border-2 rounded-xl focus:outline-none focus:ring-0 transition-all duration-200 ${
    hasError ? 'border-red-300 focus:border-red-500' : 'border-slate-200 focus:border-emerald-500'
  }`;

function FieldError({ message }) {
  if (!message) return null;
  return (
    <motion.p className="mt-2 text-sm text-red-500" initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
      {message}
    </motion.p>
  );
}
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h3 className="mb-8 text-2xl font-bold text-zinc-900">Bize mesaj gönderin</h3>
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h3 className="mb-8 text-2xl font-bold text-zinc-900">İletişime geçin</h3>
              ...
              {contactInfo.map((info, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <h4 className="mb-1 font-semibold text-zinc-900">{info.title}</h4>
                      <p className="mb-1 font-medium text-emerald-700">{info.content}</p>

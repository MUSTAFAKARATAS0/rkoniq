              ...
              >
                <button
                  ...
                  className={`px-6 py-2 rounded-full font-medium transition-all duration-200 ${
                    !isYearly ? 'bg-white text-emerald-700 shadow-sm' : 'text-zinc-600'
                  }`}
                >
                  Monthly
                </button>
              ...
              {plans.map((plan, index) => (
                ...
                >
                  {plan.popular && (
                    ...
                    >
                      <div className="bg-gradient-to-r from-emerald-600 to-green-600 text-white px-6 py-2 rounded-full text-sm font-semibold flex items-center">
                  ...
                  <div className="text-center mb-8">
                    ...
                    <motion.button
                      className={`w-full py-4 rounded-full font-semibold text-lg transition-all duration-200 ${
                        plan.popular
                          ? 'bg-gradient-to-r from-emerald-600 to-green-600 text-white hover:shadow-xl'

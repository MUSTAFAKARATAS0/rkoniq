...
const loadSolutions = () => import('../pages/Solutions.jsx');
const loadProducts = () => import('../pages/Products.jsx');
const loadAbout = () => import('../pages/About.jsx');
const loadContact = () => import('../pages/Contact.jsx');
...
export default function Home() {
  ...
  return (
    <PageLayout mainClassName="">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-12">
            <div className="z-20 text-left lg:col-span-6">
              ...
              <h1 className="mb-6 text-4xl font-bold leading-[1.12] text-zinc-900 sm:text-5xl lg:text-6xl">
                İşinizi Geleceğe <br />
      ...
      {/* Ertelenmiş (Lazy-loaded) Bölümler */}
